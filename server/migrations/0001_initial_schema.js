 ...
 * 
 * Captura o estado atual do banco para que novas instalações
 * partam do mesmo ponto que o banco existente em produção.
 */
...
export function up(db) {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS clients (
      ...
      image_rights_accepted INTEGER DEFAULT 0,
      image_rights_accepted_at TEXT,
      created_at TEXT DEFAULT CURRENT_TIMESTAMP,
      updated_at TEXT DEFAULT CURRENT_TIMESTAMP
    )
  `);
...
export function down(db) {
  // Reverter: dropar todas as tabelas (CUIDADO — destrói dados)
  ...
  db.exec(`DROP TABLE IF EXISTS client_documents`);
